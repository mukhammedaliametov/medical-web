  ...
  return (
    <div className="flex justify-center w-full h-screen bg-center bg-cover relative ">
      ...
      <div className="b-t-[1px] text-white mt-[10rem] lg:ml-[-14rem] 2xl:mt-[15rem] px-[25px]">
        ...
        <h1 className="text-3xl md:text-4xl font-montserrat py-1">Moynaq rayonı <br /> medicina birlespesi</h1>
        <p className="font-poppins text-[1.2rem] mb-[15px]">Birlespe quramında 105 - orınlı xızmet kórsetedi. <br /> Orta medicina xızmetkerleri 314-dana bolıp, sonnan 61 danası ilmiy tájriybe qatlamına iye.</p>
